      ...
      <div className="relative h-48 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center space-x-4">
          <Link
            ...
            className="px-4 py-2 bg-white bg-opacity-90 text-gray-900 rounded-md hover:bg-opacity-100 transition-all z-10" // z-indexを追加
          >
            基本情報
          </Link>
          <Link
            href={`/admin/courses/${course.id}/chapters`} // 正しいパスに修正
            className="px-4 py-2 bg-blue-500 bg-opacity-90 text-white rounded-md hover:bg-opacity-100 transition-all z-10" // z-indexを追加
          >
            チャプター管理
          </Link>
        </div>
